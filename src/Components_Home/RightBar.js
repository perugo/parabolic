...
import { BoxFocalDistance } from './Box/BoxFocalDistance';
...
export const RightBar = ({ setting, setSetting, padding, setPadding, amplitudeScaler, color, setColor, setAmplitudeScaler, showSimulation, setShowSimulation, moveVideo, setMoveVideo, setShowWindow, push, reset }) => {
      ...
      <ToggleWrapper>
        <ToggleInner>
          <BoxWrapper>
            ...
            <BoxFocalDistance {...FocalDistanceBoxProps} />
